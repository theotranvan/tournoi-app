    ...
    <div className={cn("relative", className)}>
      ...
      {open && (
        <>
          ...
          {/* Dropdown */}
          <div
            className="absolute left-0 top-full mt-2 z-50 w-80 max-h-96 overflow-y-auto rounded-xl border border-border bg-card shadow-xl animate-scale-in origin-top-left"
            role="region"
